...
export default function ProductList() {
  ...
  const handleFilter = (e, section, option) => {
    //todo: on server multiple categories
    //categories : ["smartphone","laptops"]
    //sort {_sort;"Price","_order="desc}
    console.log(e.target.checked);
    const newFilter = { ...filter };
    if (e.target.checked) {
      //if a filter is seclected then we will push in a newfilter array
      ...
      //if it is unchecked then we should remove it
